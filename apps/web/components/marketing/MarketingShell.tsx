  ...
  return (
    <footer className="border-t bg-background py-12">
      <div className="mx-auto grid max-w-6xl gap-8 px-4 md:grid-cols-[1.2fr_2fr]">
        <div>
          <p className="font-display text-2xl font-bold">JobLens AI Browser Copilot</p>
          <p className="mt-3 max-w-sm text-sm leading-6 text-muted-foreground">
            Voice-first AI assistant for summarizing webpages, analyzing job fit with your resume, and ranking candidate pools with recruiter AI.
          </p>
        </div>
