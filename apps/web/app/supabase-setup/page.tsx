      ...
      <main className="mx-auto max-w-4xl px-4 py-16">
        <div className="mb-8">
          ...
          <p className="mt-3 text-muted-foreground">
            Run the migration before using dashboard, auth profile, resume, voice, and billing features.
          </p>
        </div>
        <Card>
          <CardHeader>
          ...
          <CardContent className="space-y-5 text-sm leading-6 text-muted-foreground">
            <p>Open Supabase Dashboard, go to SQL Editor, and run the full contents of:</p>
