    ...
    <MarketingPage>
      <main className="mx-auto max-w-3xl px-4 py-16">
        ...
        <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
          <p>JobLens Voice stores resume files, parsed resume text, job page text after your explicit click, saved analyses, voice transcripts, and encrypted BYOK credential records.</p>
